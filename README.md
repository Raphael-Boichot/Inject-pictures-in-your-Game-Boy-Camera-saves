...
- Aging test can be made only by writing saves with certain patterns more or less convoluted. It must be possible to generate them onboard but I did not find how;
