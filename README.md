...
All codes given here are GNU Octave / Matlab compatible. GNU Octave is an open source version of Matlab. Codes are meant to be very easy to use / modify from any of these multi OS development environments.

The small codes [presented here](https://github.com/Raphael-Boichot/Inject-pictures-in-your-Game-Boy-Camera-saves/tree/main/Codes%20Regular%20cameras) are intended to be easy to use. Here are the steps:
