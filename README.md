...
By Raphaël BOICHOT, May 2021, a Matlab/Octave project. Last update : 2021-08-01.
...
- **0x02F00-0x02F5B : User ID, data, comments and some other information from image owner**;
	...
	- *0x02F34-0x02F35: 0x02F34-0x02F35: Probably a checksum from image data. Erasing these bytes do nothing particular, but camera rewrites them automatically. Two identical image copies have the same value.;*
