...
- **0x00000-0x00FFF: the last image seen by the sensor (128x128 pixels, 256 tiles), or camera exchange buffer. The camera copies 0x0100-0x0EFF to memory slots when save is activated (112x128 pixels). The effective visual resolution is only 128x123 as indicated in the datasheet of the M64282FP sensor. The 5 "missing lines" at the bottom of each image always return the saturation voltage (which purpose, if any, is currently undocumented);**
