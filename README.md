...
Contributions from Game Boy Camera club mates : https://github.com/cristofercruz
...
- left byte of the checksum (low address) seems to be equal to 11 + sum(left value of digits + right value of digits) (with high doubts about formula); 
- right byte of the checksum (high address) seems to be equal to 15 + sum(left value of digits - right value of digits) (with high doubts about formula); ;
...
- **0x01FFC-0x01FFF: Camera tag (0x00, 0x39, 0x00, 0x39 for western, 0x00, 0x56, 0x56, 0x53 for Corocoro, 0xAA, 0xAA, 0xAA, 0xAA for japanese);**
