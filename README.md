...
The counter for images is followed by a nice flower meter just below. I think that the game save data are not protected just because the game is not finished as the "Magic" word still exists and the game save data are not echoed contrary to the sate vector. Means that SRAM functionnality is enough for running and testing the game but not "polished" for antipiracy.
