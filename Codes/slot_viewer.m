...
disp(['number of image exchanged with males: ',dec2hex(minigames(7),2)]);
disp(['number of image exchanged with females: ',dec2hex(minigames(8),2)]);
space_fever=[dec2hex(minigames(12),2),dec2hex(minigames(11),2),dec2hex(minigames(10),2),dec2hex(minigames(9),2)];
disp(['Score at Space Fever II: ',space_fever]);
disp(['Score at Ball: ',dec2hex(minigames(14),2),dec2hex(minigames(13),2)]);
cent=[dec2hex(minigames(15),2)];
d3=9-str2num(cent(1));
d4=9-str2num(cent(2));
cent=[num2str(d3),num2str(d4)];
sec=[dec2hex(minigames(16),2)];
d1=9-str2num(sec(1));
d2=9-str2num(sec(2));
